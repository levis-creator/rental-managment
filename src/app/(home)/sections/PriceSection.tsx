      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              className="relative z-10 px-8 py-10 mb-10 overflow-hidden bg-white rounded-xl shadow-pricing dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14"
            >
              <span
                className="block mb-5 text-xl font-medium text-dark dark:text-white"
              >
                Starter
              </span>
              <h2
