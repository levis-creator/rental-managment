...
const FilterSection = ({ data }: { data: Payment[] }) => {
    ...
    return (
        <div className='shadow-md sm:rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 mb-10 p-4'>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button>
                        <Calendar className='mr-2' /> {inputData.startDate? `${inputData.startDate} - ${inputData.endDate}`:"unknown Date"}  <ChevronDown className='ml-2' />
                    </Button>
                </DropdownMenuTrigger>
